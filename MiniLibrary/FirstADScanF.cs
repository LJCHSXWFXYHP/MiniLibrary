...
namespace MiniLibrary
{
    public class FirstADScanF : Android.Support.V4.App.Fragment
    {
        ...
        {
            return inflater.Inflate(Resource.Layout.FirstADScanner, null);
        }
        ...
        public override void OnViewCreated(View view, Bundle savedInstanceState)
        {
            ...
            zxingOverlay = LayoutInflater.FromContext(this.Activity).Inflate(Resource.Layout.FirstADZxingOl, null);

...
namespace MiniLibrary
{
    public class HomeFragment : Android.Support.V4.App.Fragment
    {
        ...
        private void InitTabs()
        {
            ...
            TabHost.TabSpec tabSpec1 = this.SetIndicator(mTabHost.NewTabSpec("FirstADScanner"), "…®“ª…®");
            mTabHost.AddTab(tabSpec1, Class.FromType(typeof(FirstADScanF)), null);
            TabHost.TabSpec tabSpec2 = this.SetIndicator(mTabHost.NewTabSpec("FirstADMain"), "µØ¥∞≤‚ ‘");

...
if($myBookClassId==''){exit;}
$sql="SELECT Book.BookId, BorrowRecode.ReturnFlag FROM Book LEFT JOIN BorrowRecode ON Book.BookId = BorrowRecode.BookId WHERE Book.BookClassId='".$myBookClassId."'";

...
$sql="select Book.BookId,BorrowDate,ReturnFlag,PhoneNum,IfRenew from BorrowRecode,Book where BookClassId='".$myBookClassId."' and Book.BookId=BorrowRecode.BookId";

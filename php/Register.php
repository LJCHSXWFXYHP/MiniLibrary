...
//error_reporting(~E_ALL);
	...
	if($myPhoneNum!=''){
		$sql="select * from UserInformation where PhoneNum='".$myPhoneNum."'";
		...
		{ 
			...
			if($row['PhoneNum']==''){
				mysqli_query($conn,"INSERT INTO UserInformation (PhoneNum,Password,Type) 
									VALUES ('".$myPhoneNum."', '".$myPassword."', '1')");
				echo '1';
			}
			else{
				echo '0';

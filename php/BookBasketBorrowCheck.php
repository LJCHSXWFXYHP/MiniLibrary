<?php
	...
	$sql="SELECT COUNT(Book.BookId)  FROM Book LEFT JOIN BorrowRecode ON Book.BookId=BorrowRecode.BookId WHERE Book.BookClassId='".$myBookClassId."' AND (BorrowRecode.ReturnFlag=1 OR BorrowRecode.ReturnFlag IS NULL)";

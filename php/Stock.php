...
$myBookClassId=$_POST['BooClassId'];
$sql="select count(Book.BookId)from BorrowRecode,Book where BookClassId='".$myBookClassId."' and ReturnFlag=1  and Book.BookId=BorrowRecode.BookId";

...
namespace Manager {
    ...
    public partial class UserDataSet : global::System.Data.DataSet {
        ...
        public partial class UserInformationDataTable : global::System.Data.TypedTableBase<UserInformationRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UserInformationRow AddUserInformationRow(string PhoneNum, int Type, string Name, string IdCard, string Password) {
...
namespace Manager.UserDataSetTableAdapters {
    ...
    public partial class UserInformationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `UserInformation` WHERE ((`PhoneNum` = @p1) AND (`Type` = @p2) AND ((" +
                ...
                "L) OR (`IdCard` = @p6)) AND (`Password` = @p7))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `UserInformation` (`PhoneNum`, `Type`, `Name`, `IdCard`, `Password`) " +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `UserInformation` SET `PhoneNum` = @p1, `Type` = @p2, `Name` = @p3, `IdCard` = @p4, `Password` = @p5 WHERE ((`PhoneNum` = @p6) AND (`Type` = @p7) AND ((@p8 = 1 AND `Name` IS NULL) OR (`Name` = @p9)) AND ((@p10 = 1 AND `IdCard` IS NULL) OR (`IdCard` = @p11)) AND (`Password` = @p12))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `PhoneNum`, `Type`, `Name`, `IdCard`, `Password` FROM `UserInformation`";
        ...
        public virtual int Fill(UserDataSet.UserInformationDataTable dataTable) {
        ...
        public virtual UserDataSet.UserInformationDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UserDataSet.UserInformationDataTable dataTable = new UserDataSet.UserInformationDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UserDataSet.UserInformationDataTable dataTable) {
        ...
        public virtual int Delete(string p1, int p2, string p4, string p6, string p7) {
            if ((p1 == null)) {
        ...
        public virtual int Insert(string p1, int p2, string p3, string p4, string p5) {
            if ((p1 == null)) {
                throw new global::System.ArgumentNullException("p1");
            }
            else {
        ...
        public virtual int Update(string p1, int p2, string p3, string p4, string p5, string p6, int p7, string p9, string p11, string p12) {
            if ((p1 == null)) {
                throw new global::System.ArgumentNullException("p1");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int p2, string p3, string p4, string p5, string p6, int p7, string p9, string p11, string p12) {
